...
object TestApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val buildDir = "PATH-TO-YOUR-ANDROID-PROJECT" //e.g /Users/Desktop/awesome-app/

    val appBuildDir = buildDir + "/app/build/outputs/apk/"
    val testerClass = "TestExpresso"
    val aaptHome = "PATH-TO-YOUR-AAPT-TOOLS" // e.g "/Users/Dev/Library/Android/sdk/build-tools/24.0.3"
