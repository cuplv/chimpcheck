...
cat /chimpcheck/ChimpWebDemo/client/src/App.js | sed 's/9002/'"$STREAM_PORT"'/' > /chimpcheck/ChimpWebDemo/client/src/App2.js
cat /chimpcheck/ChimpWebDemo/client/src/App2.js > /chimpcheck/ChimpWebDemo/client/src/App.js
