...
cat /chimpcheck/ChimpWebDemo/package.json | sed 's/localhost:9002/'"$STREAM_ADDRESS":"$STREAM_PORT"'/'  > /chimpcheck/ChimpWebDemo/package2.json
cat /chimpcheck/ChimpWebDemo/package2.json > /chimpcheck/ChimpWebDemo/package.json
rm /chimpcheck/ChimpWebDemo/package2.json

cat /chimpcheck/ChimpWebDemo/client/src/Dropdown.js | sed 's/localhost:9002/'"$STREAM_ADDRESS":"$STREAM_PORT"'/' > /chimpcheck/ChimpWebDemo/client/src/App2.js
